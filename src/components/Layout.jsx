...
<Navbar />
      ...
      <div className="hero bg-transparent h-[500px]">
        <div className="hero-content text-center">
          <div className="max-w-xlg">
            <span className="relative col-start-1 row-start-1 bg-[linear-gradient(90deg,#222222,#000000)] bg-clip-text text-transparent font-cabin md:leading-[110px] text-[30px] sm:text-[50px] lg:text-[80px] xl:text-[116px] font-[800] tracking-tight z-10">
      ...
      <main>
        ...
        <section id="tutoring" className="p-4">
          <h2>Tutoring</h2>
        </section>
